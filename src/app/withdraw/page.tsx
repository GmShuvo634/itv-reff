      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">
                ${withdrawals?.weeklyRemaining.toFixed(2) || '100.00'}
              </div>
              <p className="text-xs text-muted-foreground">
                Remaining this week
              </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-orange-600">$10.00</div>
              <p className="text-xs text-muted-foreground">
                Minimum amount
              </p>
            </CardContent>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Min: $10.00 | Max: ${Math.min(walletBalance?.balance || 0, withdrawals?.weeklyRemaining || 100).toFixed(2)}
                  </p>
                </div>
                ...
                {formData.paymentMethod === 'mobile' && (
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select value={formData.paymentDetails.mobileProvider} onValueChange={(value) => setFormData({
                        ...formData,
                        paymentDetails: {...formData.paymentDetails, mobileProvider: value}
                      })}>
                        <SelectTrigger>
