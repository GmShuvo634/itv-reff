...
export default function Dashboard() {
  ...
  const { user, todayProgress, recentTransactions, referralStats } = dashboardData;
  const progressPercentage = (todayProgress.videosWatched / todayProgress.dailyLimit) * 100;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Ready to earn rewards by watching videos today?</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{todayProgress.videosWatched}/{todayProgress.dailyLimit}</div>
              <Progress value={progressPercentage} className="mt-2" />
              <p className="text-xs text-muted-foreground mt-1">
                Earned: ${todayProgress.earningsToday.toFixed(2)}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                Bonus earned: ${referralStats.referralEarnings.toFixed(2)}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {todayProgress.dailyLimit - todayProgress.videosWatched} videos remaining
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <TabsContent value="tasks" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Watch videos to earn rewards. Complete all {todayProgress.dailyLimit} videos to maximize your daily earnings.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {todayProgress.videosWatched >= todayProgress.dailyLimit ? (
                  <div className="text-center py-8">
                    <div className="text-green-600 text-6xl mb-4">🎉</div>
                    <h3 className="text-lg font-semibold text-green-600 mb-2">Daily Goal Completed!</h3>
                    <p className="text-gray-600 mb-4">
                      Congratulations! You've completed all your video tasks for today.
                    </p>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold">Start Watching Videos</h4>
                          <p className="text-sm text-gray-600">
                            {todayProgress.dailyLimit - todayProgress.videosWatched} videos remaining today
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {/* Sample video cards - these would come from API */}
                      {[1, 2, 3].map((i) => (
                        <Card key={i} className="cursor-pointer hover:shadow-md transition-shadow">
                          ...
                          <CardContent className="p-4">
                            <h4 className="font-semibold mb-2">Video Title {i}</h4>
                            <p className="text-sm text-gray-600 mb-3">Short description of the video content...</p>
          ...
          <TabsContent value="referrals" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Earn bonus rewards by inviting friends to join VideoTask Rewards
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold">{referralStats.totalReferrals}</span>
                      </div>
                      <div className="flex justify-between items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <Button className="w-full" disabled={user.walletBalance < 10}>
                        {user.walletBalance < 10 ? 'Minimum $10 required' : 'Request Withdrawal'}
                      </Button>
                    </div>
                  </div>
                </div>
