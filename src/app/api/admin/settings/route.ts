...
export async function GET(req: NextRequest) {
  try {
    ...
    if (category) {
      ...
      if (!["system", "permissions", "content", "notifications", "api"].includes(category)) {
...
export async function PUT(req: NextRequest) {
  try {
    ...
    const updatedSettings = await settingsService.updateSettingsByCategory(category, body);
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (action === "reset") {
      ...
      if (category && !["system", "permissions", "content", "notifications", "api"].includes(category)) {
        return NextResponse.json(
          {
            success: false,
            error: "Invalid category",
