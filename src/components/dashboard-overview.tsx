...
export default function DashboardOverview() {
  ...
  const progressPercentage = todayProgress.dailyLimit > 0
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{todayProgress.videosWatched || 0}/{todayProgress.dailyLimit || 0}</div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                Bonus earned: ${(referralStats?.referralEarnings || 0).toFixed(2)}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {(todayProgress.dailyLimit || 0) - (todayProgress.videosWatched || 0)} videos remaining
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <TabsContent value="tasks" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Watch videos to earn rewards. Complete all {todayProgress.dailyLimit || 0} videos to maximize your daily earnings.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {(todayProgress.videosWatched || 0) >= (todayProgress.dailyLimit || 0) ? (
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {(todayProgress.dailyLimit || 0) - (todayProgress.videosWatched || 0)} videos remaining today
                          </p>
                        </div>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold">{referralStats?.totalReferrals || 0}</span>
                      </div>
                      <div className="flex justify-between items-center">
